...
export function callback(index,carouselValue) {
...
const indexTest = `${const testImages = "https://topexplorador.com/lider_brasil/";
const indexTest = `${carouselValue}.jpg`;
const indexNew = `${testImages}${indexTest}`;.carouselValue}.jpg`;
